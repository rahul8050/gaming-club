        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button 
                onClick={(e) => { e.preventDefault(); onGalleryClick?.(); }}
                className="flex items-center justify-center gap-2 border border-neon-green text-neon-green px-8 py-4 rounded-sm font-orbitron font-bold transition-all hover:bg-neon-green/10"
              >
                <ImageIcon className="w-5 h-5 mr-2" /> CLUB PHOTOS
              </button>
            </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10 scale-110">
              ...
              <div className="absolute -bottom-6 -right-6 glass p-6 rounded-lg border-l-4 border-neon-blue shadow-xl cursor-pointer hover:scale-105 transition-transform" onClick={onGalleryClick}>
                <p className="text-xs font-orbitron text-gray-400 uppercase tracking-widest mb-1">Live Look</p>
                <p className="text-xl font-orbitron font-black text-white">CLUB PHOTOS</p>
                <p className="text-[10px] text-neon-green font-bold uppercase tracking-widest">20+ INTERIOR SHOTS</p>
              </div>
            </div>
